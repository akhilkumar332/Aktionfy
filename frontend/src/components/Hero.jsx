...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-zinc-950">
      ...
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-brand-primary/5 via-transparent to-zinc-950"></div>
      
      {/* Side Glows - Moved outside container */}
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 -left-64 w-[800px] h-[800px] bg-indigo-600/10 rounded-full blur-[160px] animate-pulse duration-[10s]"></div>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          >
            <div className="relative">
               ...
               <div className="absolute inset-0 bg-indigo-600 blur-md opacity-50 animate-pulse"></div>
            </div>
