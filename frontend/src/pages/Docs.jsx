  ...
  <DocumentationLayout>
    <div className="space-y-12">
      <header>
        ...
        <p className="text-xl text-slate-500 font-medium text-balance">Aktionfy is a production-grade orchestration engine that brings persistence and reliability to the Model Context Protocol ecosystem.</p>
      </header>
  ...
  <DocumentationLayout>
    <div className="space-y-12">
      <header>
        ...
        <p className="text-xl text-slate-500 font-medium text-balance">Comprehensive guide for deploying Aktionfy in your own environment.</p>
      </header>
  ...
  <DocumentationLayout>
    <div className="space-y-12">
      <header>
        ...
        <p className="text-xl text-slate-500 font-medium">Deep technical details on the Aktionfy implementation of the protocol.</p>
      </header>
