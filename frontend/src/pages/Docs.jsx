  ...
  <DocumentationLayout>
    <div className="space-y-12">
      <header>
        ...
        <p className="text-xl text-zinc-500 font-medium text-balance">Aktionfy is a production-grade orchestration engine that brings persistence and reliability to the Model Context Protocol ecosystem.</p>
      </header>
  ...
  <DocumentationLayout>
    <div className="space-y-12">
      <header>
        ...
        <p className="text-xl text-zinc-500 font-medium">Get your first persistent AI task running in under 5 minutes.</p>
      </header>
      ...
      <section>
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-zinc-500 italic">Alternatively, manually configure your <code>mcp_config.json</code>:</p>
          <pre className="p-6 rounded-2xl bg-zinc-950 text-emerald-400 font-mono text-sm shadow-xl">
{`{
  "mcpServers": {
    "schedule": {
  ...
  <DocumentationLayout>
    <div className="space-y-12">
      <header>
        ...
        <p className="text-xl text-zinc-500 font-medium text-balance">Comprehensive guide for deploying Aktionfy in your own environment.</p>
      </header>
      ...
      <section>
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-zinc-500">For non-NPM environments, use the standard shell installer:</p>
          <div className="p-4 bg-zinc-900 rounded-xl font-mono text-sm">
      ...
      <section className="bg-zinc-900 p-8 rounded-3xl border border-zinc-800 shadow-sm not-prose">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-left">
            <thead>
              <tr className="border-b border-zinc-800/50 text-slate-400 uppercase tracking-widest text-[10px]">
            ...
            <tbody className="divide-y divide-slate-50">
              <tr>
                ...
                <td className="py-3 px-2 text-zinc-400">PostgreSQL connection string</td>
              </tr>
              <tr>
                <td className="py-3 px-2 font-mono text-brand-primary">REDIS_URL</td>
                <td className="py-3 px-2 font-mono">localhost:6379</td>
                <td className="py-3 px-2 text-zinc-400">Redis orchestration and Pub/Sub</td>
              </tr>
              <tr>
                <td className="py-3 px-2 font-mono text-brand-primary">ENCRYPTION_KEY</td>
                <td className="py-3 px-2 text-slate-400 italic">required</td>
                <td className="py-3 px-2 text-zinc-400">64-character hex key for AES-256-GCM</td>
              </tr>
              <tr>
                ...
                <td className="py-3 px-2 text-zinc-400">Secret key for billing integration</td>
              </tr>
            </tbody>
          </table>
        </div>
  ...
  <DocumentationLayout>
    <div className="space-y-12">
      <header>
        ...
        <p className="text-xl text-zinc-500 font-medium">Understand the mental model behind our scheduling engine.</p>
      </header>
  ...
  <DocumentationLayout>
    <div className="space-y-12">
      <header>
        ...
        <p className="text-xl text-zinc-500 font-medium text-balance">Technical documentation for the REST API and MCP Tools.</p>
      </header>
        ...
        <div className="space-y-6">
          <div className="border border-zinc-800/50 rounded-2xl overflow-hidden shadow-sm bg-zinc-900">
            ...
            <div className="p-6 space-y-4">
              <p className="text-sm text-zinc-400">Creates a new durable schedule entry.</p>
          ...
          <div className="border border-zinc-800/50 rounded-2xl overflow-hidden shadow-sm bg-zinc-900">
            ...
            <div className="p-6">
              <p className="text-sm text-zinc-400">Encrypts and stores a sensitive value in the Global Secret Vault.</p>
            </div>
          </div>
          ...
          <div className="border border-zinc-800/50 rounded-2xl overflow-hidden shadow-sm bg-zinc-900">
            ...
            <div className="p-6">
              <p className="text-sm text-zinc-400">Returns a Markdown table of names of stored secrets (never exposes values).</p>
            </div>
          </div>
          ...
          <div className="border border-zinc-800/50 rounded-2xl overflow-hidden shadow-sm bg-zinc-900">
            ...
            <div className="p-6">
              <p className="text-sm text-zinc-400">Returns a beautiful Markdown table and raw JSON of all active and paused tasks.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="bg-zinc-950 p-6 rounded-2xl space-y-4 font-mono text-xs">
          <div className="flex gap-4">
            ...
            <span className="text-zinc-500 ml-auto">Retrieve account stats</span>
          </div>
          <div className="flex gap-4 border-t border-zinc-800/50 pt-4">
            ...
            <span className="text-zinc-500 ml-auto">Initiate browser session</span>
          </div>
        </div>
      </section>
    </div>
      ...
      <section className="bg-zinc-900 p-10 rounded-3xl border border-zinc-800 shadow-sm relative overflow-hidden not-prose">
        ...
        <div className="space-y-12 relative z-10">
          <div className="flex items-center gap-6">
            ...
            <div className="text-sm font-bold text-zinc-400">Claimed via SQL Lock</div>
          </div>
          <div className="flex items-center gap-6">
            <div className="w-8 h-8 rounded-full bg-zinc-950 text-white flex items-center justify-center font-bold">2</div>
            <div className="h-px flex-1 bg-zinc-900"></div>
            <div className="text-sm font-bold text-zinc-400">Published to Redis Pub/Sub</div>
          </div>
          <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="h-px flex-1 bg-zinc-900"></div>
            <div className="text-sm font-bold text-zinc-400">Result Logged & Re-scheduled</div>
          </div>
        </div>
      </section>
  ...
  <DocumentationLayout>
    <div className="space-y-12">
      <header>
        ...
        <p className="text-xl text-zinc-500 font-medium">Deep technical details on the Aktionfy implementation of the protocol.</p>
      </header>
  ...
  <DocumentationLayout>
    <div className="space-y-12">
      <header>
        ...
        <p className="text-xl text-zinc-500 font-medium">How we protect your credentials and AI tasks.</p>
      </header>
