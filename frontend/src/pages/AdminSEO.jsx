      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="bg-white/5 border border-white/10 rounded-[2rem] p-10 space-y-8 backdrop-blur-xl">
            <div>
              ...
              <input 
                ...
                placeholder="Aktionfy - Persistent AI Workflows"
              />
            </div>
        ...
        <div className="space-y-8">
           ...
           <div className="bg-white p-8 rounded-3xl shadow-2xl">
              <p className="text-[14px] text-[#202124] mb-1">https://aktionfy.com</p>
           ...
           <div className="bg-[#141413] border border-white/10 rounded-3xl overflow-hidden shadow-2xl">
              ...
              <div className="p-6">
                <p className="text-[11px] font-bold text-slate-500 uppercase tracking-widest mb-2">Aktionfy.com</p>
